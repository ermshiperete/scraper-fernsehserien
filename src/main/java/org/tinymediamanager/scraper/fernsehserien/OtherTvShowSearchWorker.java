...
class OtherTvShowSearchWorker implements Callable<List<MediaSearchResult>> {
	private MediaSearchOptions options;
	private String otherProviderName;

	public OtherTvShowSearchWorker(String otherProviderName, MediaSearchOptions options) {
