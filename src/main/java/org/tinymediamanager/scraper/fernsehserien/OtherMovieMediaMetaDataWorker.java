...
class OtherMovieMediaMetaDataWorker implements Callable<MediaMetadata> {
	private MediaScrapeOptions options;
	private String otherProviderName;

	public OtherMovieMediaMetaDataWorker(String otherProviderName, MediaScrapeOptions options) {
